...
function CreateRsoEvent()
{
    ...
    var rso = JSON.parse(localStorage.getItem("rso_event"));
    console.log(rso);
        ...
        <div className="container more">
            ...
            <Card>
                ...
                <div className="text col text-center">
                     <br></br>
                    <h3><b>RSO Event for <i>{rso.Title}</i></b></h3>
                </div>
                <br></br>
             ...
             <Form.Group controlId="formBasicLast">
                 <Form.Control className="login-input"  placeholder="Location" ref={(c) => location = c}/>
             </Form.Group>
             <Form.Group controlId="formBasicEmailAdr">
                 <Form.Control className="login-input"  placeholder="Date (MM/DD/YY)" ref={(c) => date = c}/>
             </Form.Group>
